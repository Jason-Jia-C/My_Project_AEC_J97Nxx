...
void adc_ocp()
{
	...
	{
		_sadc0	= 0B00110110;					//<7>START; <6>ADBZ; <5>ENADC; <4>ADRFS; <3:0>SACS3-SACS0 Open AN6
	}
	_sadc2	= 0b10011101;       				//<7>ADPGAEN; <4>PGAIS(VBG); <3-2>SAVRS1-SAVRS0(VBG); <1-0>PGAGS1-PGAGS0(Gain==2)
	_nop();
	_start	= 0;
...
void main()
{
    ...
    _pas1	= 0b00110000;		//<7:6>(00:PA7 11:AN7); <5:4>(00:PA6 11:OCP_1/AN6); <3:2>(00:PA5 11:AN5); <1:0>(00:PA4 11:VBAT/AN4)
    ...
    _pa		= 0b00000100;		//电平		1:高;   0:低	
    _pac	= 0b01000110;		//输入输出	1:输入; 0:输出
    _papu	= 0b00000100;		//上拉		1:使能; 0:禁止
    _pawu	= 0b00000100;		//唤醒		1:使能; 0:禁止
    _pa		= 0b00000100;		//电平		1:高;   0:低
...
//SP
	...
	while(1)
	{
		...
		{			
			...
			_pcs0	= 0b00000000;		//<5>PCS05(0:PC5 1:PWMH); <5>PCS04(0:PC4 1:PWML)
			_pa 	= 0b00000100;		//电平		1:高;	0:低	
			_pac	= 0b00000100;		//输入输出	1:输入; 0:输出
			_papu	= 0b00000100;		//上拉		1:使能; 0:禁止
			_pawu	= 0b00000100;		//唤醒		1:使能; 0:禁止
			_pa 	= 0b00000100;		//电平		1:高;	0:低	
 			_pc 	= 0b00110000;		//电平		1:高;	0:低	
